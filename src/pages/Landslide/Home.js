...
import image from "../../assets/landslidewarning.ppm"; // Replace with actual image path
        ...
        >
          ...
          <Box flex={1} mr={{ base: 0, md: 8 }} mb={{ base: 8, md: 0 }}>
            ...
            <Text fontSize="lg" mb={4}>
              The Landslide Early Warning System is a project designed to alert
              communities and authorities of potential hazards of landslides. It
